...
Widget _buildPreviewBody(
  ...
  switch (preview.type) {
    case MessagePreviewType.link:
      previewBody = buildMessageLinkPreview(
        context: context,
        preview: preview,
      );
    ...
    case MessagePreviewType.image:
      previewBody = buildMessageImagePreview(
        context: context,
        preview: preview,
      );
      break;
    case MessagePreviewType.loading:
      previewBody = buildMessageLoadingPreview(
        context: context,
        preview: preview,
      );
      break;
    case MessagePreviewType.audio:
      previewBody = buildMessageAudioPreview(
        context: context,
        preview: preview,
      );
      break;
    case MessagePreviewType.video:
      previewBody = buildMessageVideoPreview(
        context: context,
        preview: preview,
      );
      break;
    case MessagePreviewType.error:
      previewBody = buildMessageErrorPreview(
        context: context,
        preview: preview,
      );
      break;
