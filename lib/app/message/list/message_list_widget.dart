...
class _MessageListWidgetState
    extends State<MessageListWidget> {
  ...
  void initState() {
    ...
    Timer.run(() {
      ...
      _jumpToSavedIndex(chatListMessagesBloc);
    });
  }

  void _jumpToSavedIndex(MessageListBloc chatListMessagesBloc) {
...
//      _logger.d(() => "visiblePositions $visiblePositions");
      ...
      if (visiblePositions.isNotEmpty) {
        ...
        channelBloc.messagesBloc.onVisibleMessagesBounds(MessageListVisibleBounds(
