...
class IRCNetworkChannelMessageWidget extends StatelessWidget {
  final NetworkChannelMessage message;
...
//      Text("${message.type}"),
  ...
  _buildTitleIcon(NetworkChannelMessage message) {
...
isNeedHighlight(NetworkChannelMessage message) =>
    message.highlight == true ||
    message.type ==
        IRCNetworkChannelMessageType.UNKNOWN; // TODO: remove debug UNKNOWN

Color _findTitleColorDataForMessage(NetworkChannelMessage message) {
  Color color;
  switch (message.type) {
    case IRCNetworkChannelMessageType.TOPIC_SET_BY:
...
IconData _findTitleIconDataForMessage(NetworkChannelMessage message) {
  IconData icon;
  switch (message.type) {
    case IRCNetworkChannelMessageType.TOPIC_SET_BY:
...
bool isHaveLongText(NetworkChannelMessage message) =>
