...
import 'package:flutter_appirc/app/networks/irc_network_user_preferences_form_bloc.dart';
...
class IRCNetworkPreferencesFormBloc extends FormBloc {
  ...
  IRCNetworkPreferences extractData() => IRCNetworkPreferences(
      ...
      channelsFieldBloc.value
          ...
          .map((channelName) => IRCNetworkChannelPreferences(
              name: channelName, password: null, isLobby: false)).toList());
}
