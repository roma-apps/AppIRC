...
ThemeData createBaseAppIrcThemeData(Color primaryColor) => ThemeData(
      fontFamily: "Rubik",
...
abstract class IAppIrcUiTheme extends IUiTheme {
  @override
  IAppIrcUiColorTheme get colorTheme;

  @override
  IAppIrcUiTextTheme get textTheme;

  ColoredNicknamesData get nicknameColorsData;
}

abstract class IAppIrcUiColorTheme implements IUiColorTheme {
  static IAppIrcUiColorTheme of(BuildContext context, {bool listen = true}) =>
      Provider.of<IAppIrcUiColorTheme>(context, listen: listen);
}

abstract class IAppIrcUiTextTheme implements IUiTextTheme {
  static IAppIrcUiTextTheme of(BuildContext context, {bool listen = true}) =>
      Provider.of<IAppIrcUiTextTheme>(context, listen: listen);
...
class AppIrcUiTextTheme implements IAppIrcUiTextTheme {
  final IAppIrcUiColorTheme colorTheme;
