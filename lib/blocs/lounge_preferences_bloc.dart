...
class LoungePreferencesBloc
    extends PreferencesBloc<LoungePreferences> {
  LoungePreferencesBloc(PreferencesService preferencesService,
  {DefaultValueGenerator<LoungePreferences> defaultValueGenerator = createDefaultLoungePreferences})
      : super(preferencesService, _preferencesStorageKey, _jsonConverter, defaultValueGenerator);
